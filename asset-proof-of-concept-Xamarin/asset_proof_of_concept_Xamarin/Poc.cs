...
namespace asset_proof_of_concept_Xamarin
{
    using System;
    ...
    public class Poc
    {
        ...
        {
            Debug.WriteLine("[demo.html].{0}: [{1}]", topic, ArgsToString(args));
        }

        public Poc()
        {
            // Debug.WriteLine("DirectorySeparatorChar:" + Path.DirectorySeparatorChar);
        ...
        private static void Test_02_VersionAndDependenciesReport()
        {
            ...
            Debug.WriteLine("Asset {0} v{1}", asset1.Class, asset1.Version);
            foreach (KeyValuePair<String, String> dependency in asset1.Dependencies)
            {
                Debug.WriteLine("Depends on {0} v{1}", dependency.Key, dependency.Value);
            }
            Debug.WriteLine(String.Empty);

            Debug.WriteLine(AssetManager.Instance.VersionAndDependenciesReport);

            Debug.WriteLine("Version: v{0}", asset1.Version);
        ...
        private static void Test_05_EventSubscription()
        {
            ...
            //
            {
                ...
                {
                    Debug.WriteLine("[demo.html].{0}: [{1}] (delegate)", topic, ArgsToString(args));
                };
            ...
            //
            {
                ...
                {
                    Debug.WriteLine("[demo.html].{0}: [{1}] (anonymous delegate)", topic, ArgsToString(args));
                });
        ...
        private static void Test_06_SanityChecks()
        {
            ...
            //
            Debug.WriteLine("Trying to re-register: {0}", AssetManager.Instance.registerAssetInstance(asset4, asset4.Class));
        }
...
";
        ...
        private static void Test_08_Settings()
        {
            ...
            Debug.WriteLine(asset1.SettingsToXml());

            //! Log Default Settings
            asset2.Bridge = bridge1;
            Debug.WriteLine(asset2.SettingsToXml());
            ...
            if (asset3.hasSettings)
            {
                ...
                Debug.WriteLine(asset3.SettingsToXml());
            }
